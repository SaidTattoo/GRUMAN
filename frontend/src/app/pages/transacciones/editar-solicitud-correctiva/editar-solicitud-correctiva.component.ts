...
@Component({
  selector: 'app-editar-solicitud-correctiva',
  standalone: true,
  ...
  templateUrl: './editar-solicitud-correctiva.component.html',
  styleUrl: './editar-solicitud-correctiva.component.scss'
})
export class EditarSolicitudCorrectivaComponent {
