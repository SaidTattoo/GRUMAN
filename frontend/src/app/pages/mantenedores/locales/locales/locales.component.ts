...
export class LocalesComponent implements OnInit, AfterViewInit {
  private map: any;
  displayedColumns: string[] = ['numero_local', 'direccion', 'comuna', 'region', 'zona', 'grupo', 'referencia', 'telefono', 'email_local', 'email_encargado', 'nombre_encargado', 'latitud', 'longitud', 'acciones'];
